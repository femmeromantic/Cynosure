...
fun uwu() {
    val json = buildJson {
        ...
        // to json and just the invoke thing are the same
        "silly" to json {

        }
        "arf" {
            "mrraww" to "cat noises"
        }

        // Same with arrays
        "boobies" to array(17, 15, 18)
        "arf" [
            "mrrow",
            true,
            false
...
public abstract class SillyScreen<Msg> {

    public abstract fun init(): Effect<Msg>

    public abstract fun update(): Effect<Msg>

    public abstract fun ViewBuilder<Msg>.view()

}

public class Button<Msg> : Widget<Msg>

public fun <Msg> ViewBuilder<Msg>.button(/* Button builder? or params */) {

}

public class Effect<Msg>

public interface Widget<Msg>

public class ViewBuilder<Msg>